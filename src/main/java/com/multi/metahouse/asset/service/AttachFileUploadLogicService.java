...
public class AttachFileUploadLogicService {
	...
	public List<AssetContentDTO> uploadFiles(List<MultipartFile> multipartFiles, String path) throws IllegalStateException, IOException {
		List<AssetContentDTO> filedtolist = new ArrayList<AssetContentDTO>();
		...
		for(MultipartFile multipartFile : multipartFiles) {
			...
			filedtolist.add(new AssetContentDTO(null, multipartFile.getOriginalFilename(), storeFilename, count+""));
			count++;
		}
		return filedtolist;
	}
