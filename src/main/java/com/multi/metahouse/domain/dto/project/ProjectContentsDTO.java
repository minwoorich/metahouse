...
public class ProjectContentsDTO {
	...
	public ProjectContentsDTO() {
		super();
	}
	
	public ProjectContentsDTO(int project_content_id, int project_id, String project_store_filename,
	...
	public String toString() {
		return "ProjectContentsDTO [project_content_id=" + project_content_id + ", project_id=" + project_id
